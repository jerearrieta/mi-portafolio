...
const CardSocials: React.FC<CardSocialProps> = ({ icons }) => {
  return (
    <>
      {icons.map((icon, i ) => (
        <div key={i} className="rounded-xl border-2 border-gray-200 dark:border-gray-700 p-4 w-3/12 hover:border-gray-300 dark:hover:border-gray-500 hover:border-3 transition-all sm:mx-0 mx-5">
